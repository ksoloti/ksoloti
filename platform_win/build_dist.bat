...
if not defined JAVA_HOME (
   ...
   echo Azul Zulu JDK 21.30.15 (21.0.1) is recommended. Direct download: https://www.azul.com/core-post-download/?endpoint=zulu&uuid=d7b2d714-9065-45cb-b9b4-aa286b5a8f81
   pause
   goto :end
)
