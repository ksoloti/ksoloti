...
rm     ./packagetemp/linux/ksoloti-${VERSION}/firmware/build/*.elf
...
rm     ./packagetemp/linux/ksoloti-${VERSION}/firmware/flasher/flasher_build/*.elf
...
rm     ./packagetemp/linux/ksoloti-${VERSION}/firmware/mounter/mounter_build/*.elf
...
rm     ./packagetemp/mac/Ksoloti-${VERSION}.app/Contents/Resources/firmware/build/*.elf
...
rm     ./packagetemp/mac/Ksoloti-${VERSION}.app/Contents/Resources/firmware/flasher/flasher_build/*.elf
...
rm     ./packagetemp/mac/Ksoloti-${VERSION}.app/Contents/Resources/firmware/mounter/mounter_build/*.elf
...
rm     ./packagetemp/win/ksoloti-${VERSION}/firmware/build/*.elf
...
rm     ./packagetemp/win/ksoloti-${VERSION}/firmware/flasher/flasher_build/*.elf
...
rm     ./packagetemp/win/ksoloti-${VERSION}/firmware/mounter/mounter_build/*.elf
