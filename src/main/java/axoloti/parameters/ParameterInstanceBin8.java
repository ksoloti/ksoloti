 ...
 */
public class ParameterInstanceBin8 extends ParameterInstanceInt32 {

    public ParameterInstanceBin8() {
    }

    public ParameterInstanceBin8(@Attribute(name = "value") int v) {
        super(v);
    }

    @Override
    public CheckboxComponent CreateControl() {
        return new CheckboxComponent(0, 8);
    }
