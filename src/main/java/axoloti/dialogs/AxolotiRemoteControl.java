...
// button masks
    ...
    private void jButtoneEnterActionPerformed(java.awt.event.ActionEvent evt) {
        /*
         // test bitmap
    ...
    private void jButtonShiftMousePressed(java.awt.event.MouseEvent evt) {
        tx_pressed(K_SHIFT);
    }

    private void jButtonShiftMouseReleased(java.awt.event.MouseEvent evt) {
        tx_pressed(K_SHIFT);
    }
