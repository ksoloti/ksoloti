...
public class Midi extends gentools {
    ...
    static AxoObject Create_keyb_mod() {
        ...
        o.sMidiCode = "if ((status == MIDI_NOTE_ON + %midichannel%) && (data2)) {\n"
                ...
                + "    &parent->GetModulationTable()[parent->MODULATOR_attr_name_velocity * NUM_MODULATION_TARGETS],\n"
                + "    NUM_MODULATION_TARGETS,\n"
                + "    &parent->PExch[0],\n"
                + "    &parent->PExModulationPrevVal[parent->polyIndex][parent->MODULATOR_attr_name_velocity],\n"
                + "    _velo<<20);\n"
                + "  PExModulationSourceChange(\n"
                + "    &parent->GetModulationTable()[parent->MODULATOR_attr_name_note * NUM_MODULATION_TARGETS],\n"
                + "    NUM_MODULATION_TARGETS,\n"
                + "    &parent->PExch[0],\n"
                ...
                + "    _gate = 0;\n"
                + "  PExModulationSourceChange(\n"
                + "    &parent->GetModulationTable()[parent->MODULATOR_attr_name_releasevelocity * NUM_MODULATION_TARGETS],\n"
                + "    NUM_MODULATION_TARGETS,\n"
                + "    &parent->PExch[0],\n"
