...
static THD_WORKING_AREA(waThreadMidi, 256) __attribute__((section (".ccmramend")));
...
void serial_midi_init(void) {
    ...
    palSetPadMode(GPIOG, 14, PAL_MODE_ALTERNATE(8) | PAL_MODE_INPUT_PULLUP | PAL_STM32_OTYPE_PUSHPULL); /* TX */
