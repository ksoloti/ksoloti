...
void SetKVP_APVP(KeyValuePair_s *kvp, KeyValuePair_s *parent, const char *keyName, int length, KeyValuePair_s *array) {
...
void SetKVP_AVP(KeyValuePair_s *kvp, KeyValuePair_s *parent, const char *keyName, int length, KeyValuePair_s *array) {
...
void SetKVP_IVP(KeyValuePair_s *kvp, KeyValuePair_s *parent, const char *keyName, int *value, int min, int max) {
...
void SetKVP_IPVP(KeyValuePair_s *kvp, KeyValuePair_s *parent, const char *keyName, ParameterExchange_t *PEx, int min, int max) {
    PEx->signals = 0x0F;
...
void SetKVP_FNCTN(KeyValuePair_s *kvp, KeyValuePair_s *parent, const char *keyName, VoidFunction fnctn) {
...
static THD_WORKING_AREA(waThreadUI, 1500);
