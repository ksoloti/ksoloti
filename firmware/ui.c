...
#define KVP_MAX_OBJECTS 256
#define KVP_MAX_TMP_MENU_ITEMS 15
...
struct KeyValuePair *ObjectKvps[KVP_MAX_OBJECTS];
// KeyValuePair_s TmpMenuKvps[KVP_MAX_TMP_MENU_ITEMS];
