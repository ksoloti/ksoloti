...
#define MSD_DATA_SECTION        __attribute__ ((section (".bss")))
...
#define USB_DMA_DATA_SECTION    __attribute__ ((section (".ram3"))) __attribute__ ((aligned (32)))
...
#define USE_EXTERNAL_USB_FIFO_PUMP          0 /* Leave at 0, please don't change */
